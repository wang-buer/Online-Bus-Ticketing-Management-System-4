...
<html>
  ...
  String url ="/b2csys/admin/orders.jsp?1=1"; 
  ...
  <body onLoad="MM_preloadImages('/b2csys/admin/images/index_on.gif','/b2csys/admin/images/reg_on.gif','/b2csys/admin/images/order_on.gif','/b2csys/admin/images/top/topxmas/jp_on.gif','/b2csys/admin/images/top/topxmas/download_on.gif','/b2csys/admin/images/top/topxmas/bbs_on.gif','/b2csys/admin/images/top/topxmas/designwz_on.gif')" topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0">
        ...
        <form action="/b2csys/admin/orders.jsp?f=f" name="f1" method="post">
        <table cellspacing=1 cellpadding=3 align=center class=tableBorder2>
		<tr>
		<td height=25 valign=middle>
                  <img src="/b2csys/admin/images/Forum_nav.gif" align="absmiddle">
                  <a href=index.jsp>网上售票系统</a> →订单管理
		...
		<tr>
			...
			<td valign=middle align=center height=25 background="/b2csys/admin/images/bg2.gif" width=""><font color="#ffffff"><b>付款状态</b></font></td>
			...
			<td valign=middle align=center height=25 background="/b2csys/admin/images/bg2.gif" width=""><font color="#ffffff"><b>身份证号</b></font></td>
			<td valign=middle align=center height=25 background="/b2csys/admin/images/bg2.gif" width=""><font color="#ffffff"><b>是否改签</b></font></td>
		</tr>
        <%
		...
		<tr>
			...
			<td class=tablebody1 valign=middle width="" align="center"><%=order.getIsgq() %></td>
		</tr>
        <%} %>     
		</table>
		<br>
...
<script type="text/javascript">
	...
	function edit(id)
	{
		...
		if(no!=null){%>
		 alert("此订单中有库存不足的车票，请检查余票！");
		 parent.location.replace("/b2csys/admin/orders.jsp");
		 <%}%>
</script>