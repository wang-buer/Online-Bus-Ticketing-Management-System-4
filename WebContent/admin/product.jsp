...
<html>
  ...
  String url ="/b2csys/admin/product.jsp?1=1"; 
  ...
  <body onLoad="MM_preloadImages('/b2csys/admin/images/index_on.gif','/b2csys/admin/images/reg_on.gif','/b2csys/admin/images/order_on.gif','/b2csys/admin/images/top/topxmas/jp_on.gif','/b2csys/admin/images/top/topxmas/download_on.gif','/b2csys/admin/images/top/topxmas/bbs_on.gif','/b2csys/admin/images/top/topxmas/designwz_on.gif')" topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0">
        ...
        <form action="/b2csys/admin/product.jsp?f=f" name="f1" method="post">
        <table cellspacing=1 cellpadding=3 align=center class=tableBorder2>
		<tr>
		<td height=25 valign=middle>
                  <img src="/b2csys/admin/images/Forum_nav.gif" align="absmiddle">
                  <a href=index.jsp>网上售票系统</a> →车票管理
		...
		<tr>
			...
			<td valign=middle align=center height=25 background="/b2csys/admin/images/bg2.gif" ><font color="#ffffff"><b>所属线路</b></font></td>
			<td valign=middle align=center height=25 background="/b2csys/admin/images/bg2.gif" ><font color="#ffffff"><b>价格</b></font></td>
			<td valign=middle align=center height=25 background="/b2csys/admin/images/bg2.gif" ><font color="#ffffff"><b>余票</b></font></td>
			<td valign=middle align=center height=25 background="/b2csys/admin/images/bg2.gif" ><font color="#ffffff"><b>操作</b></font></td>
		</tr>
        <%
        PageManager pageManager = PageManager.getPage("/b2csys/admin/product.jsp?1=1",10, request);
		...
		<tr>
			...
			%>
			<%=kc %>
			<a href="javascript:rk(<%=product.getId() %>)"> 加票</a></td>
...
<script type="text/javascript">
	function add()
	{
		pop("/b2csys/admin/productadd.jsp","新增车票",400,250);
	}
	function edit(id)
	{
		pop("/b2csys/admin/productedit.jsp?id="+id,"编辑车票",400,250);
	}
	function settj(id){
		pop("/b2csys/admin/productsettj.jsp?id="+id,"设置特价",300,100);
	}
	function rk(id){
		pop("/b2csys/admin/productrk.jsp?id="+id,"加票",300,100);
	}
</script>