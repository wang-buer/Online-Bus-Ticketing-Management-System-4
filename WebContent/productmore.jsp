        ...
        <TR>
          ...
          <TABLE border=0 cellSpacing=0 cellPadding=0 width=100%>
                    ...
                    <TR>
                      ...
                      align=middle>全部车票</TD>
                      <TD background=files/ne1.jpg 
                      align=right>&nbsp;<A 
                  href="/b2csys/productmore.jsp"><STRONG>more</STRONG></A></TD>
            ...
            <TABLE class=bb border=0 cellSpacing=0 cellPadding=0 align=center>
              ...
              <TR>
                <TD>
                  ...
                  <%
                  String hql = " from Product where delstatus=0 order by field1 desc";
                  String url = "/b2csys/productmore.jsp?1=1";
                  int a = 0;
                  PageManager pageManager = PageManager.getPage("/b2csys/productmore.jsp?1=1",12, request);
